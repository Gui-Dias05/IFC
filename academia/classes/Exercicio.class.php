<?php
    ...
    class Exercio extends BancoDados {
        ...
        public function Salvar() {
            try {
                $sql = "INSERT INTO `academia`.`exercicio` (`nome_exercicio`) VALUES (:nome)";
        ...
        public static function ListarExercicio($tipo = 0, $info = "") {
            try {
                $sql = "SELECT * FROM academia.exercicio";
                if ($tipo > 0)
                    switch ($tipo) {
        ...
        public  function Excluir() {
            try {
                $sql = "DELETE FROM academia.exercicio WHERE id_exercicio = :id";
        ...
        public  function Editar() {
            try {
                $sql = "UPDATE academia.exercicio SET nome_exercicio = :nome WHERE id_exercicio = :id";
                $param = array( ":nome" => $this->getNome(), 
                                ":id" => $this->getId());
                $teste = parent::Execute($sql, $param);
                return $teste;
