<?php
    ...
    class Treino extends BancoDados{
        ...
        public function Salvar(){
            try{
                $sql = "INSERT INTO `academia`.`treino` (`treino_repeticao`, `treino_tipo`, `id_usuario`) 
                VALUES (:rep,:tip,:usu)";
        ...
        public static function Listar($tipo = 0, $info = ""){
            try{
                $sql = "SELECT * FROM academia.treino";
                if($tipo > 0)
                    switch ($tipo) {
        ...
        public function Editar(){
            try{
                $sql = "UPDATE academia.treino SET treino_repeticao = :treino_repeticao, treino_tipo = :treino_tipo WHERE id_treino = :id";
        ...
        public function Excluir(){
            try{
                $sql = "DELETE FROM academia.treino WHERE id_treino = :id";
