...
const char ssid[] = "IF_CATARINENSE"; //Nome da rede  IFC: linksys
const char password[] = "ifcatarinense"; //Senha da rede IFC: 123456789

String HOST_NAME = "http://172.16.1.207"; // Troque para o ip da sua máquina  'pc ifc: 192.168.1.100'
