...
<body>
    ...
    <section id="projeto">
        <form action="requisitoProg.php?idpro=<?php echo $dados['id']?>" method="POST" style="color: #fff;" class="card-projeto">
            <div><h2>Projeto</h2></div><br>
            <div class="col-auto">
                <div class="input-group">
                    <label class="input-group-text border border-dark rounded-start" for="nome">Nome do projeto</label>
                    <input type="text" id="nome" name="nome" style="width: 65.3%; background-color:#fff;" required class="form-control-sm border border-dark rounded-end" value="<?php echo $dados['nome'];?>" disabled>
                </div>
            </div><br>
            <div class="col-auto">
                <div class="input-group">
