...
<?php
    ...
    if($acao == "insert") {
        try{
            $tri = new Triangulo("", $cor, $idtabuleiro, $lado1, $lado2, $lado3);
            $tri->inserir();
            header("location:cadTriangulo.php");
        } catch(Exception $e) {
...
<body>
    ...
    <content>
    <form action="<?php if(isset($_GET['id'])) { echo "cadTriangulo.php?id=$id&acao=editar";} else {echo "cadTriangulo.php?acao=insert";}?>" method="post" id="form" style="padding-left: 0.7px;">
        <h1>Criar um Triangulo</h1><br>
        <input readonly type="hidden" name="id" id="id" value="<?php if (isset($id)) echo $lista[0]['id'];?>">
        <div class="col-auto">
            <div class="input-group">    
                <div class="input-group-text border border-dark rounded-start">Lado 1:</div>
                <input required type="text" name="lado1" id="lado1" value="<?php if (isset($id)) echo $lista[0]['lado1'];?>" class="form-control-sm border border-dark rounded-end">
            </div>
        </div><br>
        <div class="col-auto">
            <div class="input-group">    
                <div class="input-group-text border border-dark rounded-start">Lado 2:</div>
                <input required type="text" name="lado2" id="lado2" value="<?php if (isset($id)) echo $lista[0]['lado2'];?>" class="form-control-sm border border-dark rounded-end">
        </div><br>
        <div class="col-auto">
            <div class="input-group">    
                <div class="input-group-text border border-dark rounded-start">Lado 3:</div>
                <input required type="text" name="lado3" id="lado3" value="<?php if (isset($id)) echo $lista[0]['lado3'];?>" class="form-control-sm border border-dark rounded-end">
        </div><br>
        <div class="col-auto">
            <div class="input-group">    
    ...
    <form method="post" style="padding-left: 0.7px;">
        ...
        <div class="form-check">
            ...
            <input type="radio" name="buscar" value="6" <?php if ($buscar == "6") echo "checked" ?> class="form-check-input">
            ...
            <table border='1' class="table table-light table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><a href="../show/mostrartri.php?id=<?php echo $linha['id'];?>"><img src="../img/eye.svg" alt=""></a></td>
                        ...
                        <td><a onclick="return confirm('Deseja mesmo excluir?')" href="cadTriangulo.php?id=<?php echo $linha['id'];?>&acao=excluir"><img src="../img/trash-2.svg" alt=""></a></td>
                    </tr>
                <?php } ?> 
                </tbody>
            </table>
